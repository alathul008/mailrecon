...
export type TimelineEvent={id:number;timestamp:string;last_seen?:string|null;collected_at:string;kind:string;label:string;source:string;value:string;severity:string;confidence:number;evidence_state?:string|null};
